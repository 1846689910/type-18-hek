  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-evenly" }}>
        <button className="btn btn-primary" onClick={props.showAll}>
          All
        </button>
        <button className="btn btn-primary" onClick={props.showCompleted}>
          Completed
        </button>
        <button className="btn btn-primary" onClick={props.showActive}>
          Active
        </button>
        <Link to="/">
